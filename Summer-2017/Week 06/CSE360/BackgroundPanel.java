...
public class BackgroundPanel extends JPanel
{
	...
	private static JPanel setGround;
	private static JPanel newBackground;
	...
	public static JPanel setGhost(JPanel newPanel) {
		layeredPane.setPreferredSize(new Dimension(250,150));
		newPanel.setPreferredSize(new Dimension(250, 150));
		newPanel.setBounds(1,1,250,150);
		layeredPane.setBounds(0,0,250,150);
		layeredPane.setOpaque(false);
		newPanel.setVisible(true);
		
        layeredPane.add(ghost, JLayeredPane.PALETTE_LAYER);
        newPanel.add(layeredPane, BorderLayout.CENTER);
        newPanel.setSize(10, 10);
        newPanel.add(ghost, BorderLayout.CENTER);
        return newPanel;
	}
	
	public static JPanel removeGhost(JPanel newPanel) {
		newPanel.remove(ghost);
		newPanel.revalidate();
		newPanel.repaint();
		return newPanel;
	}
	
	public static JPanel showGhost(JPanel newPanel) {
		layeredPane.add(ghost, JLayeredPane.PALETTE_LAYER);
        newPanel.add(layeredPane, BorderLayout.CENTER);
        newPanel.setSize(10, 10);
        newPanel.add(ghost, BorderLayout.CENTER);
